    ...
    <View style={styles.requisitionCard}>
      <View style={styles.cardHeader}>
        ...
        <Text
          style={[
            styles.cardStatus,
            styles[`status${item.status.replace(" ", "")}` as keyof typeof styles],
          ]}
        >
          {item.status}
        </Text>
      ...
      <View style={styles.amountContainer}>
        <View style={styles.amountBox}>
          ...
          <Text style={styles.amountValue}>₹{item.requestedAmount.toFixed(2)}</Text>
        </View>
        ...
        <View style={styles.amountBox}>
          ...
          <Text
            style={[
              styles.amountValue,
              { color: item.approvedAmount > 0 ? "#10b981" : "#64748b" },
            ]}
          >
      ...
      <View style={styles.filtersCard}>
        <ScrollView style={styles.filtersContainer}>
          <View style={styles.filterSection}>
            <Text style={styles.filterLabel}>Requisition Type</Text>
